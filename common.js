...
const kSeekToReq            = 7;
const kSetAudioSpeed        = 8;
const kDecodeVideo          = 9;
const kDecodeAudio          = 10;
...
const kSeekToRsp            = 10;
const kFeedDataRsp          = 11;
const kAudioParam           = 12;
const kVideoParam           = 13;
const kStreamParam          = 14;
const kInitRender           = 15;
const kUnitRender           = 16;
const kRenderFrame          = 17;
const kTransferBuffer       = 18;
const kVideoDemuxed         = 19;
const kAudiooDemuxed        = 20;
const kSpendDataRsp         = 21;
const kUnitRenderRsp        = 22;
const kSetCanvasSize        = 23;
const kReturnVideoBuffer    = 24;

const kConsoleReq           = 40;
